<template>
  <div class="relative pt-[160px] overflow-x-clip">
    ...
    <div class="relative pl-[6.875rem] pb-30">
      ...
      <div class="text-[52px] font-bold leading-none mb-[80px]">
        量身打造品牌門面
      </div>
      <div class="space-y-[60px]">
        <div class="space-y-[16px]">
          <div class="flex items-center space-x-[24px]">
            <img src="../assets/images/project-team.svg" alt="" />
            <div class="text-[24px] font-bold">
              專業團隊協作｜設計 × 程式的雙重保障
            </div>
          </div>
          <div class="text-[#5B5B5B] text-[20px] pl-[54px]">
            從設計思考到技術落地，由專職設計與工程團隊分工合作，確保每個細節都不馬虎。
          </div>
        </div>

        <div class="space-y-[16px] pl-[50px]">
          <div class="flex items-center space-x-[24px]">
            <img src="../assets/images/custom-project.svg" alt="" />
            <div class="text-[24px] font-bold">
              高彈性客製方案｜從小型網站到系統平台
            </div>
          </div>
        ...
        <div class="space-y-[16px] pl-[100px]">
          <div class="flex items-center space-x-[24px]">
            <img src="../assets/images/ongoing-maintenance.svg" alt="" />
            <div class="text-[24px] font-bold">
              持續維護支援｜讓網站長期為你工作
            </div>
          </div>
