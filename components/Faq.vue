...
const allFaqs: Record<Category, Faq[]> = {
  ...
  `,
    ...
    },
    {
      ...
      title: "網站需要多久時間製作？",
      content:
        "依據網站複雜程度而定，簡易網站約 3～4 週，進階功能網站如電商或會員系統或更客製化網站，需經過評估。",
    },
    {
      value: "item-8",
  ...
  marketing: [
    ...
    },
    {
      ...
      title: "限時動態設計的交付檔格式？",
      content:
        "提供 JPG/PNG/GIF 檔（依需求），建議尺寸 1080x1920px。若需加入互動功能（如投票、問答），請提前告知。",
    },
    ...
    },
    {
      ...
      title: "發文排程如何安排？",
      content:
        "我們會根據您的產業特性，建議最佳發文時段（例：電商適合晚間 8-10 點），並於每月初提供內容日曆確認。",
    },
    ...
    },
    {
      ...
      title: "沒有適合的方案怎麼辦？",
      content:
        "歡迎聯繫我們討論客製化報價！提供「需求表單」勾選項目後，將於 1-3 個工作天提供專屬方案。",
    },
    {
      value: "payment",
      title: "付款方式和合約如何簽訂？",
  ...
  design: [
    ...
    },
    {
      ...
      content:
        "基礎動態含：文字浮入、簡單轉場、元素微動畫。<br/>若需複雜特效（如粒子動畫、3D旋轉），需另報價。",
    },
    ...
    // 網站設計系統
    {
      ...
      content:
        "包含首頁+4個核心頁面（如產品頁/關於頁/聯絡頁）的線框稿。<br/>超出頁數按NT$2,000/頁計費。",
    },
    ...
    // 通用問題
    {
      ...
      title: "成品不滿意可以修改嗎？",
      content:
        "每項服務包含2次免費修改（需於交付後7日內提出），額外修改依工時計費（NT$500/小時）。",
    },
    {
      value: "payment",
      title: "付款方式和合約如何進行？",
      content:
        "單次專案付50%訂金，尾款於交付前結清；包套服務可分期。<br/>合約電子簽署，明確定義交付項目與時程。",
    },
  ],
};
...
<template>
  <div class="relative pt-24 pb-40 overflow-x-clip">
    ...
    <div class="px-10 flex justify-center flex-col items-center">
      ...
      <div
        class="ttext-gray-600 text-[16px] md:text-[20px] text-center md:mb-10"
      >
    ...
    <div class="relative w-full px-[10%]">
      <Accordion
        type="single"
        collapsible
        :default-value="currentFaqs[0]?.value"
      >
        <AccordionItem
