...
<template>
  <div class="relative md:py-40 py-32 overflow-hidden">
    <div
      class="absolute left-1/2 -translate-x-1/2 md:translate-x-0 min-[480px]:text-[100px] min-[737px]:text-[120px] top-10 md:left-24 text-[70px] md:text-[200px] font-bold md:text-[#FAFAFA] leading-none text-gray-100 opacity-50 select-none z-0"
    >
      Project
    </div>
    ...
    <div class="relative px-6 flex justify-center flex-col items-center text-center z-10">
      ...
      <div
        class="grid w-full max-w-7xl lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:mt-[120px] mt-12 gap-10 md:gap-6 items-stretch"
      >
        <div
