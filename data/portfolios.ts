...
export const portfolios: Portfolio[] = [
  {
    ...
    description: 'Luxe Travel 是專精於歐洲度假的頂級旅遊規劃平台。我提供多元化的旅遊服務,包括精選團體旅遊、客製化自由行和豪華郵輪,旨在滿足您對完美旅程的所有嚮往。憑藉 30 年豐富的歐洲行程規劃經驗,我在各大旅遊論壇上獲得了卓越的聲譽和好評。至今,我已幫助超過 3,000 名旅客實現探索歐洲的夢想,並為數百對新人打造難忘的蜜月之旅。',
    features: [
      '精選團體旅遊方案',
      '客製化自由行規劃',
      '豪華郵輪行程',
  ...
  },
  {
    ...
    description: '體驗兩全其美的旅遊方式——完整的行程彈性與專業團體旅遊的可靠便利。省去訂房和駕駛的麻煩,透過專車接送和導遊服務,您的愉快旅程從出發那一刻就開始了。我致力於提供最輕鬆、最享受的旅遊體驗。',
    features: [
      '彈性客製化行程',
      '專車接送服務',
      '專業導遊陪同',
  ...
  },
  {
    ...
    description: 'VIDA 是一個以創作者為中心的平台，提供粉絲觀看、評論與私訊功能。創作者可透過「設定付款」或「訂閱內容」功能吸引流量並變現。官方團隊同時提供包裝與引流協助，增加作品曝光。',
    features: [
      '訂閱制付費功能',
      '創作者與粉絲私訊系統',
      '多語系支援 (Vue-i18n)',
  ...
  },
  {
    ...
    category: '網站設計',
    shortDesc: '一站式數位服務平台',
    description: 'Zeona 提供一站式數位服務,涵蓋品牌建立、網站開發與數位行銷。從 0 到 1,我提供多種量身定制的方案,滿足您的特定需求。無論是初創品牌還是成熟企業,我都能協助您在數位世界中建立強大的品牌形象。',
    features: [
      '響應式網頁設計 (RWD)',
      'SEO 搜尋引擎優化',
      '流暢的動畫效果 (Lottiefiles)',
  ...
  },
  {
    ...
    features: [
      ...
      '叫車服務參數設定',
      'QR Code 叫車管理',
      '設計規範系統 (Design Guideline)',
    ],
    techStack: ['HTML', 'JavaScript','Bootstrap', 'CSS', 'Figma',],
    image: oneCallCarBg,
  ...
  },
  {
    ...
    category: '網站設計',
    shortDesc: '電子乘車券服務入口',
    description: '解決業主對員工交通差旅的管理需求，並提供成員電子乘車券服務。透過形象官網，讓企業用戶了解數位簽單的實際運作方式。',
    features: [
      '視差滾動效果 (Rellax.js)',
      'Wow.js 滾動動畫',
      'FB Pixel & GA 追蹤整合',
  ...
  },
  {
    ...
    description: '積極實踐新技術的 Side Project。具備導航篩選功能，讓訪客能輕鬆搜尋景點資訊。整合地圖圖資，提供直覺的地理位置查詢體驗。',
    features: [
      '互動式地圖串接 (Leaflet)',
      '景點類別過濾篩選',
      'Pinia 狀態管理',
    ...
    techStack: ['NaiveUI', 'Leaflet', 'VITE','Figma', 'HTML', 'SCSS', 'Vue', 'RWD', 'TailwindCss', 'Axios', 'Pinia', 'Vue-Router', 'Vercel Deploy'],
    image: travelTw,
