...
export const portfolios: Portfolio[] = [
  ...
  },
  {
    ...
    techStack: ['Figma', 'HTML', 'CSS', 'Bootstrap', 'JavaScript'],
    image: oneCallCarBg,
  ...
  },
  {
    ...
    techStack: ['Figma', 'HTML', 'SCSS', 'Bootstrap', 'jQuery', 'RWD', 'Form Validation'],
    image: oneId,
  ...
  },
  {
    ...
    techStack: ['Nuxt.js', 'Vue.js', 'Google Sheets API', 'Vercel', 'Video Interaction', 'RWD'],
    image: photography,
  ...
  },
  {
    ...
    techStack: ['Figma', 'HTML', 'SCSS', 'Bootstrap', 'jQuery', 'RWD', 'Lottie Animations'],
    image: qrcode,
  ...
  },
  {
    ...
    techStack: ['Figma', 'HTML', 'CSS', 'Core UI', 'jQuery', 'ASP.Net MVC'],
    image: ticketBg,
  ...
  },
  {
    ...
    techStack: ['Fite', 'Vue', 'TailwindCss', 'Axios', 'Leaflet', 'Pinia', 'Vue-Router', 'NaiveUI'],
    image: travelTw,
  ...
  },
  {
    ...
    techStack: ['Figma', 'HTML', 'SCSS', 'jQuery', 'Vue.js', 'ASP.Net MVC'],
    image: tww,
  ...
  },
  {
    ...
    techStack: ['Figma', 'Nuxt', 'Vue', 'Swiper', 'Vant', 'Vue-i18n', 'Vuex', 'Axios'],
    image: vida,
...
export const categories = ['全部', '品牌官網', '電商開發', '行銷營運', '品牌設計']
