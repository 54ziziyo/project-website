...
export const portfolios: Portfolio[] = [
  ...
  },
  {
    ...
    description: `Fantasi.one 是一個專為創作者與粉絲打造的獨特交流空間，創作者可以在平台上分享精彩的影片內容。<br/><br/>粉絲則可透過訂閱或單次購買的方式，取得專屬的獨家內容存取權限。平台致力於建立創作者與粉絲之間更緊密的連結，讓創作價值得到更好的實現。<br />※ 本案為任職於德騏期間之作品`,
    features: [
...
。<br /><br />
  ...
  },
  {
    ...
    category: '視覺設計',
    shortDesc: '電子乘車券服務入口',
    description: `解決企業對員工交通差旅的管理需求，並提供成員電子乘車券服務。透過形象官網，讓企業用戶了解數位簽單之服務。<br /><br />※ 本案為任職於台灣大車隊期間之作品`,
    features: [
      '視差滾動效果 (Rellax.js)',
      'Wow.js 滾動動畫',
      'FB Pixel & GA 追蹤整合',
...

  {
    ...
    description: `佈署於車站、餐廳與商辦入口，為未下載叫車 App 的乘客提供掃碼即用的服務。提供多套 ColorStyle.css 供不同企業選擇，並進行 A/B 測試比較傳統風格與現代風格的使用者反饋。<br /><br />※ 本案為任職於台灣大車隊期間之作品`,
    features: [
      'A/B 測試排版優化',
      '多主題色彩換膚系統',
      'Lottie 動態效果整合',
  ...
  },
  {
    ...
    description: `「企業簽單後台管理系統」讓業主能集中管理員工差旅，清楚查看每趟行程的地點、時間與費用，簡化報支流程。<br /><br />※ 本案為任職於台灣大車隊期間之作品`,
    features: [
      '差旅費用集中化管理',
      '行程時間地點精準追蹤',
      '報支流程自動化',
  ...
  },
  {
    ...
    description: `新一代會員系統「OneID」，為集團提供統一的註冊、登入、授權與驗證入口。透過共享帳號機制，整合集團內各項服務的登入介面與驗證流程。<br /><br />※ 本案為任職於台灣大車隊期間之作品`,
    features: [
      '統一身分驗證入口',
      '集團共享帳號機制',
  ...
  },
  {
    ...
    description: `針對潔衣家官方網站進行行動裝置優化，讓 55688 APP 使用者能流暢購買洗衣服務。從流程規劃、畫面設計到前端切版與後端串接皆一手包辦，大幅提升購物體驗。<br /><br />※ 本案為任職於台灣大車隊期間之作品`,
    features: [
      '行動裝置專屬切版',
      'App 內嵌網頁流程規劃',
      '完整原型 (Prototype) 製作',
