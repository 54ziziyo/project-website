...
• 演講介紹卡`,
  ...
  // ─── 素材工具包 ───────────────────────────────────────────────
  {
    ...
    name: '超級語音助手｜讓 AI 更懂你的第一步',
    category: '素材工具包',
    price: 0,
    description:
      '用說的比打字快 10 倍。免費下載 Typeless，口說自我介紹後讓 AI 幫你彙整，再搭配提示詞——產出的東西會更完整、更像你。',
    fullDescription: `你有沒有遇過這個問題：照著提示詞貼給 AI，產出的東西感覺很通用、跟你沒關係？

因為 AI 不知道你是誰。

每次下提示詞之前，你都要先告訴 AI 你的背景、你在做什麼——但打字說明一遍又一遍，非常花時間。

這就是我一直推薦大家先下載 **Typeless** 的原因。
...
說完之後，Typeless 會把你說的話清楚轉成文字並整理好。把這段內文貼到任何提示詞的最前面，AI 立刻就知道在跟誰說話——產出的內容更精準、更有你的味道。
...
Typeless 解決了這件事。直接按下翻譯，它會原封不動把對方說的話即時呈現在螢幕上。雖然沒辦法馬上快速回話，但你至少先看懂對方在說什麼——這在陌生環境裡非常重要。
