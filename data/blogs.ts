...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <h2>一、深度思考類</h2>
      <ol>
        <li><strong>/think</strong> — 讓AI深入思考再回答，不要給表面答案<br><span style="color:#6b7280;font-size:14px;">範例：<code>/think 我的電商網站預計下週要做萬聖節限量搶購活動，預估瞬時流量會暴增50倍，目前架構是單一資料庫，該怎麼優化才能防崩潰？</code></span></li>
        <li><strong>/alt3</strong> — 提供三種不同角度的答案，讓你比較（可調整成/alt4、/alt5，建議最多到/alt5，超過角度容易重複、也難消化）<br><span style="color:#6b7280;font-size:14px;">範例：<code>/alt3 我要賣一款「無咖啡因、幫助睡眠」的漢方黑豆茶。幫我寫一句吸引人的IG廣告文案。</code></span></li>
        <li><strong>/blind-spot</strong> — 主動找出你可能忽略的盲點<br><span style="color:#6b7280;font-size:14px;">範例：<code>/blind-spot 我打算開一個日本代購IG帳號，主打機車部品，這個計畫有什麼我可能沒想到的風險？</code></span></li>
        <li><strong>/devil</strong> — 唱反調，專門找你論點裡的漏洞<br><span style="color:#6b7280;font-size:14px;">範例：<code>/devil 我覺得漲價20%不會影響銷量，反駁我這個想法。</code></span></li>
        <li><strong>/root-cause</strong> — 挖到問題的根本原因，不只是表面症狀<br><span style="color:#6b7280;font-size:14px;">範例：<code>/root-cause 最近IG貼文觸及率突然掉了一半，可能的根本原因是什麼？</code></span></li>
        <li><strong>/first-principles</strong> — 用第一性原理重新拆解問題，不套用現成答案<br><span style="color:#6b7280;font-size:14px;">範例：<code>/first-principles 不要照搬同業的做法，從頭想一個代購金流加物流的最省成本方案。</code></span></li>
        <li><strong>/worst-case</strong> — 列出最壞情況，並給出對應方案<br><span style="color:#6b7280;font-size:14px;">範例：<code>/worst-case 我準備跟廠商簽一年份的獨家代理合約，列出最壞情況與應對備案。</code></span></li>
        <li><strong>/assumptions</strong> — 列出這個答案背後隱藏了哪些假設<br><span style="color:#6b7280;font-size:14px;">範例：<code>/assumptions 我認為粉絲主要是20-30歲女性，這個判斷背後我可能默認了哪些沒驗證過的假設？</code></span></li>
      </ol>

      <h2>二、溝通與寫作類</h2>
      <ol start="9">
        <li><strong>/no-fluff</strong> — 砍掉所有廢話，只留重點<br><span style="color:#6b7280;font-size:14px;">範例：<code>/no-fluff 小型電商網站要串金流，用綠界還是藍新？用一個Markdown表格只比較：手續費、審核速度、串接難易度。</code></span></li>
        <li><strong>/human</strong> — 用更自然、更像真人的口吻回答，不要機器人腔<br><span style="color:#6b7280;font-size:14px;">範例：<code>/human 用第一人稱分享一個「第一次去日本獨旅，結果在電車上睡過頭坐到終點站」的趣味小故事。</code></span></li>
        <li><strong>/eli5</strong> — 用小學生也聽得懂的方式解釋（Explain Like I'm 5）<br><span style="color:#6b7280;font-size:14px;">範例：<code>/eli5 什麼是API金鑰，為什麼外流會很危險？</code></span></li>
        <li><strong>/tone-casual</strong> — 改成輕鬆口語的語氣<br><span style="color:#6b7280;font-size:14px;">範例：<code>/tone-casual 幫我把這則產品公告改成朋友聊天的口吻。</code></span></li>
        <li><strong>/tone-formal</strong> — 改成正式、專業的語氣<br><span style="color:#6b7280;font-size:14px;">範例：<code>/tone-formal 幫我把這封催款訊息改成正式但不失禮貌的語氣。</code></span></li>
        <li><strong>/shorten</strong> — 精簡到一半字數，但保留關鍵重點<br><span style="color:#6b7280;font-size:14px;">範例：<code>/shorten 這段商品描述字數砍半，但賣點不能少。</code></span></li>
        <li><strong>/bullet</strong> — 全部用條列式呈現，不要長段落<br><span style="color:#6b7280;font-size:14px;">範例：<code>/bullet 把這篇教學文章的步驟整理成條列式，不要長段落。</code></span></li>
        <li><strong>/story</strong> — 用故事或比喻說明，不要條列知識點<br><span style="color:#6b7280;font-size:14px;">範例：<code>/story 用故事的方式解釋「為什麼代購要抓匯率階梯」這件事，不要條列規則。</code></span></li>
      </ol>

      <h2>三、決策與分析類</h2>
      <ol start="17">
        <li><strong>/pros-cons</strong> — 列出優缺點對照表<br><span style="color:#6b7280;font-size:14px;">範例：<code>/pros-cons 廠商A跟廠商B的供貨條件，列出優缺點對照表。</code></span></li>
        <li><strong>/decision-matrix</strong> — 用評分矩陣幫你做決定<br><span style="color:#6b7280;font-size:14px;">範例：<code>/decision-matrix 我在考慮要不要投放IG廣告，用評分矩陣幫我評估。</code></span></li>
        <li><strong>/risk</strong> — 抓出這個決定潛在的風險<br><span style="color:#6b7280;font-size:14px;">範例：<code>/risk 我打算把商品都改成預購制，抓出這個決定的潛在風險。</code></span></li>
        <li><strong>/compare</strong> — 比較兩個選項之間的差異<br><span style="color:#6b7280;font-size:14px;">範例：<code>/compare 比較用WooCommerce跟Shopify開店的差異。</code></span></li>
        <li><strong>/prioritize</strong> — 幫你把多項任務排出優先順序<br><span style="color:#6b7280;font-size:14px;">範例：<code>/prioritize 這五件待辦（上架新品、回覆客訴、跑廣告報表、備貨、拍照）幫我排優先順序。</code></span></li>
      </ol>

      <h2>四、創意與腦力激盪類</h2>
      <ol start="22">
        <li><strong>/brainstorm</strong> — 生成大量點子，先不篩選<br><span style="color:#6b7280;font-size:14px;">範例：<code>/brainstorm 幫我想20個IG限動可以發的內容主題，先不用篩選。</code></span></li>
        <li><strong>/wild</strong> — 給一個瘋狂、不切實際但有啟發性的點子<br><span style="color:#6b7280;font-size:14px;">範例：<code>/wild 給我一個瘋狂但有啟發性的行銷點子，用在代購業務上。</code></span></li>
        <li><strong>/remix</strong> — 把兩個不相關的概念混在一起，生出新點子<br><span style="color:#6b7280;font-size:14px;">範例：<code>/remix 把「日本鄉土祭典」跟「機車部品開箱」這兩個不相關的概念混在一起，生出一個內容點子。</code></span></li>
        <li><strong>/alternative</strong> — 給三個完全不同方向的替代方案<br><span style="color:#6b7280;font-size:14px;">範例：<code>/alternative 這次新品命名，給我三個完全不同方向的替代方案。</code></span></li>
      </ol>

      <h2>五、學習與理解類</h2>
      <ol start="26">
        <li><strong>/teach-me</strong> — 用蘇格拉底式提問，引導你自己想通，不直接給答案<br><span style="color:#6b7280;font-size:14px;">範例：<code>/teach-me 我想搞懂關稅計算的邏輯，用蘇格拉底式提問引導我自己想通，不要直接給答案。</code></span></li>
        <li><strong>/quiz-me</strong> — 針對剛剛學到的內容出題考你<br><span style="color:#6b7280;font-size:14px;">範例：<code>/quiz-me 針對我剛剛學的Yoast SEO規則出題考我。</code></span></li>
        <li><strong>/analogy</strong> — 用生活化的類比解釋抽象概念<br><span style="color:#6b7280;font-size:14px;">範例：<code>/analogy 用生活化的比喻解釋「什麼是API」。</code></span></li>
        <li><strong>/step-by-step</strong> — 拆解成具體、可執行的一步一步流程<br><span style="color:#6b7280;font-size:14px;">範例：<code>/step-by-step 把「怎麼申請Meta商業驗證」拆解成具體步驟。</code></span></li>
      </ol>

      <h2>六、效率與格式類</h2>
      <ol start="30">
        <li><strong>/table</strong> — 用表格呈現內容<br><span style="color:#6b7280;font-size:14px;">範例：<code>/table 把這幾款相機的規格整理成表格。</code></span></li>
        <li><strong>/tldr</strong> — 給三句話以內的摘要<br><span style="color:#6b7280;font-size:14px;">範例：<code>/tldr 這篇落落長的合約條款，給我三句話摘要。</code></span></li>
        <li><strong>/checklist</strong> — 轉換成可以打勾的清單<br><span style="color:#6b7280;font-size:14px;">範例：<code>/checklist 把「新品上架SOP」轉換成可以打勾的清單。</code></span></li>
        <li><strong>/template</strong> — 給一個能直接套用的模板<br><span style="color:#6b7280;font-size:14px;">範例：<code>/template 給我一個IG貼文文案的萬用模板。</code></span></li>
      </ol>

      <h2>七、商業與職場類</h2>
      <ol start="34">
        <li><strong>/email</strong> — 把這段話改寫成專業得體的email<br><span style="color:#6b7280;font-size:14px;">範例：<code>/email 把這段抱怨語氣的話，改寫成專業得體的email給廠商。</code></span></li>
        <li><strong>/pitch</strong> — 用30秒電梯簡報的方式講重點<br><span style="color:#6b7280;font-size:14px;">範例：<code>/pitch 用30秒電梯簡報介紹我的代購品牌。</code></span></li>
        <li><strong>/negotiate</strong> — 針對談判情境，給出應對話術<br><span style="color:#6b7280;font-size:14px;">範例：<code>/negotiate 廠商想漲價，幫我想談判時可以用的話術。</code></span></li>
        <li><strong>/boss-mode</strong> — 用老闆會問的角度來檢視這件事<br><span style="color:#6b7280;font-size:14px;">範例：<code>/boss-mode 用老闆會問的角度來檢視我這個月的行銷企劃。</code></span></li>
        <li><strong>/meeting-notes</strong> — 把對話內容整理成會議紀錄格式<br><span style="color:#6b7280;font-size:14px;">範例：<code>/meeting-notes 把這段跟廠商的對話整理成會議紀錄。</code></span></li>
        <li><strong>/objection</strong> — 預測對方可能提出的反對意見，並準備好回應<br><span style="color:#6b7280;font-size:14px;">範例：<code>/objection 客人可能會質疑代購價格比日本官網貴，預測他們的反對意見並準備好回應。</code></span></li>
      </ol>

      <h2>八、程式與技術類</h2>
      <ol start="40">
        <li><strong>/debug</strong> — 找出這段程式碼可能出錯的地方<br><span style="color:#6b7280;font-size:14px;">範例：<code>/debug 這段Nuxt的API路由一直回傳500，幫我找出可能出錯的地方。</code></span></li>
        <li><strong>/explain-code</strong> — 逐行解釋這段程式碼在做什麼<br><span style="color:#6b7280;font-size:14px;">範例：<code>/explain-code 逐行解釋這段爬蟲程式碼在做什麼。</code></span></li>
        <li><strong>/refactor</strong> — 優化這段程式碼的可讀性跟效率<br><span style="color:#6b7280;font-size:14px;">範例：<code>/refactor 優化這段重複很多次的商品定價計算邏輯。</code></span></li>
        <li><strong>/edge-case</strong> — 列出這個邏輯可能漏掉的邊界情況<br><span style="color:#6b7280;font-size:14px;">範例：<code>/edge-case 這個訂單金額計算邏輯，可能漏掉哪些邊界情況（例如0元訂單、負數折扣）？</code></span></li>
      </ol>

      <h2>九、情緒與個人成長類</h2>
      <ol start="44">
        <li><strong>/reframe</strong> — 用更正向、更有建設性的角度重新詮釋這件事<br><span style="color:#6b7280;font-size:14px;">範例：<code>/reframe 這次跟廠商談判沒談成，幫我用更正向的角度重新詮釋這件事。</code></span></li>
        <li><strong>/vent</strong> — 先讓你發洩情緒，不要急著給建議<br><span style="color:#6b7280;font-size:14px;">範例：<code>/vent 今天客訴處理到很累，先讓我發洩一下，不要急著給建議。</code></span></li>
        <li><strong>/coach</strong> — 用教練式提問，幫你釐清目標，而不是直接給建議<br><span style="color:#6b7280;font-size:14px;">範例：<code>/coach 我不確定該不該把代購事業轉型做自有品牌，用教練式提問幫我釐清目標。</code></span></li>
      </ol>

      <h2>十、進階組合類</h2>
      <ol start="47">
        <li><strong>/chain</strong> — 把任務拆成多個步驟，一步步引導你完成<br><span style="color:#6b7280;font-size:14px;">範例：<code>/chain 把「規劃一場新品上市直播」拆成多個步驟，一步步引導我完成。</code></span></li>
        <li><strong>/persona</strong> — 假設AI是某個角色/專家身份，用那個角度回答<br><span style="color:#6b7280;font-size:14px;">範例：<code>/persona 假設你是資深電商顧問，用那個角度幫我看這份營運報告。</code></span></li>
        <li><strong>/socratic</strong> — 不斷反問你，直到你自己想清楚答案<br><span style="color:#6b7280;font-size:14px;">範例：<code>/socratic 針對「要不要漲價」這件事，不斷反問我，直到我自己想清楚答案。</code></span></li>
        <li><strong>/source</strong> — 要求附上這個答案的可信度或來源依據，不要憑空講<br><span style="color:#6b7280;font-size:14px;">範例：<code>/source 你說台灣電商轉換率平均是多少，附上這個數字的來源依據。</code></span></li>
      </ol>
